...
def simulate_vehicle_movement():
    ...
    #add some randomness to simulate real time road travel
...
def simulate_journey(producer,device_id):
    while True:
        ...
        traffic_camera_data = generate_traffic_camera_data(device_id,vehicle_data['timestamp'],vehicle_data['location'],camera_id='Nikon123')
