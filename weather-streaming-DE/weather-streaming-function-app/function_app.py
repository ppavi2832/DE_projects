...
def weatherapifunction(myTimer: func.TimerRequest) -> None:
    ...
    EVENT_HUB_NAMESPACE = "weatherstreaming1namespace.servicebus.windows.net" 
    ...
    def fetch_weather_data():
        ...
        location = "Tirupati"  # You can replace with any city name based on your preference

        # Fetch the API key from Key Vault
        VAULT_URL = "https://keyv1-weather-streaming.vault.azure.net/"
